...
datacsv.apply_algorithm(algorithm='linearsvc', params={'random_state': 0, 'C': 0.01, 'max_iter': 1000})
datacsv.apply_algorithm(algorithm='linearsvc', params={'random_state': 0, 'C': 1000, 'max_iter': 1000})
datacsv.apply_algorithm(algorithm='logreg', params={'random_state': 0, 'C': 0.01, 'max_iter': 1000})
datacsv.apply_algorithm(algorithm='logreg', params={'random_state': 0, 'C': 1000, 'max_iter': 1000})
...
datacsv.apply_algorithm(algorithm='mlp', params={'random_state': 0, 'activation': 'tanh', 'alpha': 0.01,
                                                 'max_iter': 1000, 'hidden_layer_sizes': [50, 50]})
datacsv.apply_algorithm(algorithm='mlp', params={'random_state': 0, 'activation': 'tanh', 'alpha': 0.01,
